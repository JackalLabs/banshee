...
export type TCreateExtension = (base: QueryClient) => Record<string, Record<string, (request?: any) => Promise<any>>>
export type TQueryLibrary = QueryClient & Record<string, Record<string, (request?: any) => Promise<any>>>
